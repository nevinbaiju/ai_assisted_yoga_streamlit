...
class PoseEstimator:
    ...
    def calculate_angle(self, point_1, point_2, point_3):
        ...
        return int(math.degrees(math.atan(tan_angle)))
    ...
    def get_angles(self, pose_coords):
        ...
        angle_dict['left_shoulder'] = self.calculate_angle((left_elbow_x, left_elbow_y), (left_shoulder_x, left_elbow_y), (left_hip_x, left_hip_y))
        ...
        angle_dict['right_shoulder'] = self.calculate_angle((right_elbow_x, right_elbow_y), (right_shoulder_x, right_elbow_y), (right_hip_x, right_hip_y))
